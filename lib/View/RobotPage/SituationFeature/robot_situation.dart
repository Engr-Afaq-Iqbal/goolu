...
class _RobotSituationState extends State<RobotSituation> {
  ...
  @override
  void initState() {
    Get.find<RobotController>().customQuestionCtrl.clear();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<RobotController>(
          builder: (RobotController robotCtrl) {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border:
                                              Border.all(color: kYellowffde59),
                                        ),
                                        child: Column(
                                          children: [
                                            Row(
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 24.0,
            decoration: BoxDecoration(
              color: k7F7F7F.withOpacity(0.3),
              shape: BoxShape.circle,
            ),
            child: Center(
              child: Icon(Icons.check, color: kWhite, size: 18),
            ),
          ),
          size30w,
          Expanded(
